...
def gerar_csv():
   ...
   # Renomeia a coluna "Serial Killer" para "Serial Killer Real"
   vitimas_teste_df.rename(columns={'Serial Killer': 'Serial Killer Real'}, inplace=True)
   
   # Embaralhando a ordem das vítimas
   vitimas_treino_df = vitimas_treino_df.sample(frac=1)
   vitimas_teste_df = vitimas_teste_df.sample(frac=1)
   ...
   return{'msg':'Arquivos gerados com sucesso!'}
